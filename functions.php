...
function post_has_archive( $args, $post_type ) {
	...
	if ( 'post' == $post_type ) {
		$args['rewrite'] = true;
		$args['has_archive'] = 'catintro'; //任意のスラッグ名
	}
	return $args;
...
function cptui_register_my_cpts_catintro() {
	...
	$labels = [
		"name" => esc_html__( "猫紹介", "custom-post-type-ui" ),
		"singular_name" => esc_html__( "catintro", "custom-post-type-ui" ),
	];

	$args = [
		"label" => esc_html__( "猫紹介", "custom-post-type-ui" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
